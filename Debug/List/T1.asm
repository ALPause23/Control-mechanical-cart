...
; 0000 0015     DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(24)
	OUT  0x17,R30
...
; 0000 0050     // INT0: Off
; 0000 0051     // INT1: Off
; 0000 0052     MCUCR=(0<<ISC11) | (1<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(4)
	OUT  0x35,R30
; 0000 0053     GICR|=(1<<INT1) | (0<<INT0);
	...
	ORI  R30,0x80
	OUT  0x3B,R30
; 0000 0054     MCUCR=(0<<ISC11) | (1<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(4)
	OUT  0x35,R30
