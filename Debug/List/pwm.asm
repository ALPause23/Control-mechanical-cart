...
;AVR Core Clock frequency: 0,270000 MHz
;Memory model            : Small
;External RAM size       : 0
;Data Stack size         : 256
;*******************************************************/
...
; 0000 0026 {
_init_PWM_timer:
; .FSTART _init_PWM_timer
; 0000 0027     ASSR=0x00;
	LDI  R30,LOW(0)
	OUT  0x22,R30
; 0000 0028     TCCR2=0b01101110;
	LDI  R30,LOW(110)
	RCALL SUBOPT_0x0
...
; 0000 0031 unsigned char pwm_state;
...
; 0000 0048 TCCR0=(0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 006D TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	LDI  R30,LOW(0)
	OUT  0x39,R30
; 0000 006E 
...
; 0000 0083 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0084 
...
; 0000 008C port_ini();
	RCALL _port_ini
; 0000 008D init_PWM_timer();
	RCALL _init_PWM_timer
; 0000 008E pwm_state = 0;
	LDI  R17,LOW(0)
; 0000 008F while (1)
_0x3:
; 0000 0090       {
; 0000 0091          if (pwm_state==0)
	CPI  R17,0
	BRNE _0x6
; 0000 0092           {
; 0000 0093             OCR2++;
	...
	SUBI R30,-LOW(1)
	OUT  0x23,R30
; 0000 0094             if (OCR2>254)
	IN   R30,0x23
	CPI  R30,LOW(0xFF)
	BRLO _0x7
; 0000 0095             {
; 0000 0096               pwm_state=1;
	LDI  R17,LOW(1)
; 0000 0097             }
; 0000 0098           }
_0x7:
; 0000 0099           if (pwm_state==1)
_0x6:
	CPI  R17,1
	BRNE _0x8
; 0000 009A           {
